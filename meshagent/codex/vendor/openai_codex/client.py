...
def _path_codex_path() -> Path | None:
    codex_path = shutil.which("codex")
    return Path(codex_path) if codex_path is not None else None
...
class CodexBinResolverOps:
    ...
    path_codex_path: Callable[[], Path | None]
...
def _default_codex_bin_resolver_ops() -> CodexBinResolverOps:
    return CodexBinResolverOps(
        ...
        path_codex_path=_path_codex_path,
...
def resolve_codex_bin(config: "AppServerConfig", ops: CodexBinResolverOps) -> Path:
    ...
    path_codex = ops.path_codex_path()
...
class AppServerClient:
    ...
    def account_logout(self) -> LogoutAccountResponse:
        return self.request(
            "account/logout", None, response_model=LogoutAccountResponse
        )
